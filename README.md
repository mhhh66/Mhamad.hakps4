...
3. From the terminal on your router, run these commands:
    ```sh
    wget -O /tmp/installer.sh https://raw.githubusercontent.com/Mohammed61111/Mhamad.hakps4/main/installer.sh
...
3. Desde el terminal en tu router, ejecuta estos comandos:
    ```sh
    wget -O /tmp/installer.sh https://raw.githubusercontent.com/CodeInvers3/Mhamad.hakps4/main/installer.sh
    chmod +x /tmp/installer.sh
    /tmp/installer.sh
    ```
